...
const Header = () => {
  ...
  return (
    ...
    >
      {/* left */}
      <div className="relative flex items-center h-32 cursor-pointer my-auto">
        <Image
      ...
      {/* Middle - Search */}
      <div
        className="flex items-center md:border-2 rounded-full py-2 h-12
      md:shadow-sm"
      >
        <input
          value={searchInput}
        ...
        />
        <SearchIcon
          className="h-8 bg-red-400 text-white rounded-full p-1 cursor-pointer
        hidden md:inline-flex md:mx-2"
        />
      </div>
      {/* Right */}
